...
$factory->define(Order::class, function (Faker $faker) {
    ...
    // 随机生成发货状态
    $ship = $faker->randomElement(array_keys(OrderDict::$shipStatusMap));
    // 优惠券
    $coupon = null;
    // 30% 概率该订单使用了优惠券
    ...
    return [
        ...
        'refund_status'  => $refund ? OrderDict::REFUND_STATUS_SUCCESS : OrderDict::REFUND_STATUS_PENDING,
        'refund_no'      => $refund ? Order::getAvailableRefundNo() : null,
        'closed'         => false,
        'reviewed'       => random_int(0, 10) > 2,
        'ship_status'    => $ship,
        'ship_data'      => $ship === OrderDict::SHIP_STATUS_PENDING ? null : [
